...
function Section$4({
  ...
  const className = classNames(styles$1c.Section, secondary && styles$1c['Section-secondary'], fullWidth && styles$1c['Section-fullWidth'], oneHalf && styles$1c['Section-oneHalf'], oneThird && styles$1c['Section-oneThird']);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  }, children);
}
...
function Link({
  ...
  if (external && typeof children === 'string') {
    ...
    childrenMarkup = /*#__PURE__*/React__default.createElement(React__default.Fragment, null, children, /*#__PURE__*/React__default.createElement("span", {
      className: styles$1d.IconLockup
    }, /*#__PURE__*/React__default.createElement("span", {
      className: styles$1d.IconLayout
    }, /*#__PURE__*/React__default.createElement(Icon, {
  ...
  return /*#__PURE__*/React__default.createElement(BannerContext.Consumer, null, BannerContext => {
    ...
    const className = classNames(styles$1d.Link, shouldBeMonochrome && styles$1d.monochrome, removeUnderline && styles$1d.removeUnderline);
...
class List extends React.PureComponent {
  render() {
    ...
    const className = classNames(styles$1e.List, type && styles$1e[variationName('type', type)]);
...
function MediaCard({
  ...
  const primaryActionMarkup = primaryAction ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1f.PrimaryAction
  }, buttonFrom(primaryAction)) : null;
  const secondaryActionMarkup = secondaryAction ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1f.SecondaryAction
  }, buttonFrom(secondaryAction, {
    plain: true
  })) : null;
  const actionClassName = classNames(styles$1f.ActionContainer, portrait && styles$1f.portrait);
  ...
  const mediaCardClassName = classNames(styles$1f.MediaCard, portrait && styles$1f.portrait);
  const mediaContainerClassName = classNames(styles$1f.MediaContainer, portrait && styles$1f.portrait, size === 'small' && styles$1f.sizeSmall);
  const infoContainerClassName = classNames(styles$1f.InfoContainer, portrait && styles$1f.portrait, size === 'small' && styles$1f.sizeSmall);
  return /*#__PURE__*/React__default.createElement(Card, null, /*#__PURE__*/React__default.createElement("div", {
...
function Item$7({
  ...
  if (url == null) {
    const _className = classNames(styles$1g.Item, disabled && styles$1g['Item-disabled'], keyFocused && styles$1g.keyFocused);

    return /*#__PURE__*/React__default.createElement("li", {
      className: styles$1g.ListItem
    }, /*#__PURE__*/React__default.createElement("button", {
      type: "button",
  ...
  const itemClassName = classNames(styles$1g.Item, disabled && styles$1g['Item-disabled'], selected && subNavigationItems.length === 0 && styles$1g['Item-selected'], showExpanded && styles$1g.subNavigationActive, keyFocused && styles$1g.keyFocused);
  ...
  if (subNavigationItems.length > 0) {
    ...
    const SecondaryNavigationClassName = classNames(styles$1g.SecondaryNavigation, showExpanded && styles$1g.isExpanded, !icon && styles$1g['SecondaryNavigation-noIcon']);
  ...
  const className = classNames(styles$1g.ListItem, secondaryAction && styles$1g['ListItem-hasAction']);
  return /*#__PURE__*/React__default.createElement("li", {
    className: className
  }, /*#__PURE__*/React__default.createElement("div", {
...
function Section$5({
  ...
  const className = classNames(styles$1g.Section, separator && styles$1g['Section-withSeparator'], fill && styles$1g['Section-fill']);
  ...
  const sectionHeadingMarkup = title && /*#__PURE__*/React__default.createElement("li", {
    className: styles$1g.SectionHeading
  }, /*#__PURE__*/React__default.createElement("span", {
    className: styles$1g.Text
  }, title), actionMarkup);
  ...
  const toggleClassName = classNames(styles$1g.Item, styles$1g.RollupToggle);
  ...
  const activeItemsMarkup = rollup && additionalItems.length > 0 && /*#__PURE__*/React__default.createElement("li", {
    className: styles$1g.RollupSection
...
const Navigation$1 = function Navigation({
  ...
  return /*#__PURE__*/React__default.createElement(NavigationContext.Provider, {
    ...
    className: styles$1g.PrimaryNavigation
  }, children))));
};
...
function TooltipOverlay({
  ...
  function renderTooltip(overlayDetails) {
    ...
    const containerClassName = classNames(styles$1h.TooltipOverlay, measuring && styles$1h.measuring, positioning === 'above' && styles$1h.positionedAbove);
    const contentStyles = measuring ? undefined : {
...
function Title({
  ...
  const pageTitleClassName = thumbnail ? styles$1i.hasThumbnail : undefined;
  return /*#__PURE__*/React__default.createElement("div", {
    className: pageTitleClassName
  }, thumbnailMarkup, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1i.TitleAndSubtitleWrapper
...
function Header$2({
  ...
  const breadcrumbMarkup = breadcrumbs.length > 0 ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1j.BreadcrumbWrapper
  ...
  const paginationMarkup = pagination && !isNavigationCollapsed ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1j.PaginationWrapper
  ...
  const additionalNavigationMarkup = additionalNavigation ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1j.AdditionalNavigationWrapper
  ...
  const pageTitleMarkup = /*#__PURE__*/React__default.createElement("div", {
    className: styles$1j.TitleWrapper
  ...
  const additionalMetadataMarkup = additionalMetadata ? /*#__PURE__*/React__default.createElement("div", {
    className: styles$1j.AdditionalMetaData
  }, /*#__PURE__*/React__default.createElement(TextStyle, {
    variation: "subdued"
  }, additionalMetadata)) : null;
  const headerClassNames = classNames(styles$1j.Header, isSingleRow && styles$1j.isSingleRow, titleHidden && styles$1j.titleHidden, navigationMarkup && styles$1j.hasNavigation, actionMenuMarkup && styles$1j.hasActionMenu, isNavigationCollapsed && styles$1j.mobileView, !breadcrumbs.length && styles$1j.noBreadcrumbs, title && title.length < LONG_TITLE && styles$1j.mediumTitle, title && title.length > LONG_TITLE && styles$1j.longTitle);
  const {
    slot1,
    slot2,
    slot3,
...
function PrimaryActionMarkup({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$1j.PrimaryActionWrapper
  }, content);
}
...
function Page(_ref) {
  ...
  const className = classNames(styles$1k.Page, fullWidth && styles$1k.fullWidth, narrowWidth && styles$1k.narrowWidth);
...
function ProgressBar({
  ...
  const i18n = useI18n();
  const className = classNames(styles$1m.ProgressBar, size && styles$1m[variationName('size', size)]);
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    className: styles$1m.Progress,
    value: parsedProgress,
    max: "100"
  }), /*#__PURE__*/React__default.createElement("div", {
    className: styles$1m.Indicator,
    style: {
...
class DualThumb extends React.Component {
  ...
  render() {
    ...
    const ariaDescribedBy = describedBy.length ? describedBy.join(' ') : undefined;
    const trackWrapperClassName = classNames(styles$1n.TrackWrapper, error && styles$1n.error, disabled && styles$1n.disabled);
    const thumbLowerClassName = classNames(styles$1n.Thumbs, styles$1n.ThumbLower, disabled && styles$1n.disabled);
    const thumbUpperClassName = classNames(styles$1n.Thumbs, styles$1n.ThumbUpper, disabled && styles$1n.disabled);
    ...
    const outputLowerClassName = classNames(styles$1n.Output, styles$1n.OutputLower);
    ...
    const outputUpperClassName = classNames(styles$1n.Output, styles$1n.OutputUpper);
    ...
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Labelled, {
      ...
      className: styles$1n.Track,
      style: cssVars,
      ref: this.track
    }), /*#__PURE__*/React__default.createElement("div", {
      className: styles$1n['Track--dashed']
    }), /*#__PURE__*/React__default.createElement("div", {
      id: idLower,
...
function SingleThumb(props) {
  ...
  const outputMarkup = !disabled && output && /*#__PURE__*/React__default.createElement("output", {
    htmlFor: id,
    className: styles$1o.Output
  }, /*#__PURE__*/React__default.createElement("div", {
    className: styles$1o.OutputBubble
  }, /*#__PURE__*/React__default.createElement("span", {
    className: styles$1o.OutputText
  }, clampedValue)));
  const prefixMarkup = prefix && /*#__PURE__*/React__default.createElement("div", {
    className: styles$1o.Prefix
  }, prefix);
  const suffixMarkup = suffix && /*#__PURE__*/React__default.createElement("div", {
    className: styles$1o.Suffix
  }, suffix);
  const className = classNames(styles$1o.SingleThumb, error && styles$1o.error, disabled && styles$1o.disabled);
  return /*#__PURE__*/React__default.createElement(Labelled, {
    id: id,
    label: label,
    error: error,
    ...
    className: styles$1o.InputWrapper
  }, /*#__PURE__*/React__default.createElement("input", {
    type: "range",
  ...
  render() {
    ...
    if (media || selectable) {
      ownedMarkup = /*#__PURE__*/React__default.createElement("div", {
        className: classNames(styles$1p.Owned, !mediaMarkup && styles$1p.OwnedNoMedia)
      }, handleMarkup, mediaMarkup);
    }

    const className = classNames(styles$1p.ResourceItem, focused && styles$1p.focused, selectable && styles$1p.selectable, selected && styles$1p.selected, selectMode && styles$1p.selectMode, persistActions && styles$1p.persistActions, focusedInner && styles$1p.focusedInner);
    const listItemClassName = classNames(styles$1p.ListItem, focused && !focusedInner && styles$1p.focused);
    ...
    if (shortcutActions && !loading) {
      if (persistActions) {
        ...
        disclosureMarkup = /*#__PURE__*/React__default.createElement("div", {
          className: styles$1p.Disclosure,
          onClick: stopPropagation$1
        }, /*#__PURE__*/React__default.createElement(Popover, {
          activator: /*#__PURE__*/React__default.createElement(Button, {
    ...
    const containerClassName = classNames(styles$1p.Container, verticalAlignment && styles$1p[variationName('alignment', verticalAlignment)]);
...
function Select({
  ...
  const className = classNames(styles$1q.Select, error && styles$1q.error, disabled && styles$1q.disabled);
  ...
  const inlineLabelMarkup = labelInline && /*#__PURE__*/React__default.createElement("span", {
    className: styles$1q.InlineLabel
  }, label);
  ...
  const contentMarkup = /*#__PURE__*/React__default.createElement("div", {
    ...
    className: styles$1q.SelectedOption
...
const ResourceList = function ResourceList({
  ...
  const headerMarkup = !showEmptyState && showHeader !== false && !showEmptySearchState && (showHeader || needsHeader) && listRef.current && /*#__PURE__*/React__default.createElement("div", {
    ...
    const headerClassName = classNames(styles$1r.HeaderWrapper, sortOptions && sortOptions.length > 0 && !alternateTool && styles$1r['HeaderWrapper-hasSort'], alternateTool && styles$1r['HeaderWrapper-hasAlternateTool'], isSelectable && styles$1r['HeaderWrapper-hasSelect'], loading && styles$1r['HeaderWrapper-disabled'], isSelectable && selectMode && styles$1r['HeaderWrapper-inSelectMode'], isSticky && styles$1r['HeaderWrapper-isSticky']);
    return /*#__PURE__*/React__default.createElement("div", {
      className: headerClassName
  ...
  const className = classNames(styles$1r.ItemWrapper, loading && styles$1r['ItemWrapper-isLoading']);
  const loadingWithoutItemsMarkup = loading && !itemsExist ? /*#__PURE__*/React__default.createElement("div", {
    className: className,
    tabIndex: -1
  }, loadingOverlay) : null;
  const resourceListClassName = classNames(styles$1r.ResourceList, loading && styles$1r.disabledPointerEvents, selectMode && styles$1r.disableTextSelection);
...
function SkeletonDisplayText({
  ...
  const className = classNames(styles$1v.DisplayText, size && styles$1v[variationName('size', size)]);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  });
}
...
function SkeletonPage({
  ...
  const i18n = useI18n();
  const className = classNames(styles$1w.Page, fullWidth && styles$1w.fullWidth, narrowWidth && styles$1w.narrowWidth);
  const titleContent = title ? /*#__PURE__*/React__default.createElement("h1", {
    className: styles$1w.Title
  }, title) : /*#__PURE__*/React__default.createElement("div", {
    className: styles$1w.SkeletonTitle
  });
  const titleMarkup = /*#__PURE__*/React__default.createElement("div", {
    className: styles$1w.TitleWrapper
  }, titleContent);
  const primaryActionMarkup = primaryAction ? /*#__PURE__*/React__default.createElement("div", {
...
function SkeletonThumbnail({
  ...
  const className = classNames(styles$1x.SkeletonThumbnail, size && styles$1x[variationName('size', size)]);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className
  });
}
...
class Item$8 extends React.PureComponent {
  ...
  render() {
    ...
    const classname = classNames(styles$1y.Item);
    const sharedProps = {
      id,
...
function Panel({
  ...
  const className = classNames(styles$1y.Panel, hidden && styles$1y['Panel-hidden']);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className,
    id: id,
    role: "tabpanel",
...
function Tab({
  ...
  const className = classNames(styles$1y.Tab, selected && styles$1y['Tab-selected']);
  let tabIndex;
  ...
  const tabContainerClassNames = classNames(styles$1y.TabContainer, selected && styles$1y.Underline);
...
const TabMeasurer = /*#__PURE__*/React.memo(function TabMeasurer({
  ...
  const classname = classNames(styles$1y.Tabs, styles$1y.TabMeasurer);
  return /*#__PURE__*/React__default.createElement("div", {
    className: classname,
    ref: containerNode
  }, /*#__PURE__*/React__default.createElement(EventListener, {
...
class TabsInner extends React.PureComponent {
  ...
  render() {
    ...
    const classname = classNames(styles$1y.Tabs, fitted && styles$1y.fitted, disclosureActivatorVisible && styles$1y.fillSpace);
    const disclosureTabClassName = classNames(styles$1y.DisclosureTab, disclosureActivatorVisible && styles$1y['DisclosureTab-visible']);
    const disclosureButtonClassName = classNames(styles$1y.DisclosureActivator, hasCustomDisclosure && styles$1y.Tab);
    const disclosureButtonContentWrapperClassName = classNames(styles$1y.Title, hasCustomDisclosure && styles$1y.titleWithIcon);
    const disclosureButtonContent = hasCustomDisclosure ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, disclosureText, _ref$p) : _ref2$7;
...
function Thumbnail({
  ...
  const className = classNames(styles$1z.Thumbnail, size && styles$1z[variationName('size', size)]);
...
function Search({
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, overlayMarkup, /*#__PURE__*/React__default.createElement("div", {
    ...
    className: styles$1B.SearchContent
  }, /*#__PURE__*/React__default.createElement("div", {
...
function SearchField({
  ...
  const className = classNames(styles$1C.SearchField, (focused || active || forceActive) && styles$1C.focused);
  return /*#__PURE__*/React__default.createElement("div", {
    className: className,
    onFocus: handleFocus,
    onBlur: handleBlur
...
const TopBar = function TopBar({
  ...
  const iconClassName = classNames(styles$1H.NavigationIcon, focused && styles$1H.focused);
  ...
  if (contextControl) {
    ...
    const className = classNames(styles$1H.LogoContainer, showNavigationToggle || searchField ? styles$1H.LogoDisplayControl : styles$1H.LogoDisplayContainer);
    contextMarkup = /*#__PURE__*/React__default.createElement("div", {
      className: className
    }, /*#__PURE__*/React__default.createElement(UnstyledLink, {
      url: logo.url || '',
...
function VideoThumbnail({
  ...
  const timeStampMarkup = videoLength ? /*#__PURE__*/React__default.createElement("p", {
    className: classNames(styles$1I.Timestamp, showVideoProgress && styles$1I.withProgress)
  ...
  if (showVideoProgress) {
    ...
    progressMarkup = /*#__PURE__*/React__default.createElement("div", {
      className: styles$1I.Progress
    }, /*#__PURE__*/React__default.createElement("progress", {
      className: styles$1I.ProgressBar,
      value: progressValuePercents,
      max: "100"
    }), /*#__PURE__*/React__default.createElement("div", {
      className: styles$1I.Indicator,
      style: {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: styles$1I.Thumbnail,
    style: {
      backgroundImage: `url(${thumbnailUrl})`
    }
  }, /*#__PURE__*/React__default.createElement("button", {
    type: "button",
    className: styles$1I.PlayButton,
